...
import { useBookingProvider } from '../../BookingPageProvider';
...
export const BookingWizard = ({ isOpen, setIsOpen }: Props) => {
  const { bookingWizardError, setBookingWizardError } = useBookingProvider();
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  <div className="flex items-center h-full">
                    ...
                    {/* {currentStep === WIZARD_STEP.ORGANIZATION_BOOKING && (
                      <AnimationWrapper
                        key={WIZARD_STEP.ORGANIZATION_BOOKING}
                      >
                        <OrganizationBookingStep
                          isStepLoading={deduplicateSameOrganization.isLoading}
                          stepBookingResponse={sameOrgDedupResponse}
                          duplicatesToUpload={sameOrgDedupUploadCount}
                        />
                      </AnimationWrapper>
                    )} */}

                    {/* {currentStep === WIZARD_STEP.REGISTRY_BOOKING && (
                      <AnimationWrapper key={WIZARD_STEP.REGISTRY_BOOKING}>
                        <RegistryBookingStep
                          isStepLoading={
                            deduplicateSystemOrganizations.isLoading ||
                            deduplicateSameOrganization.isLoading
                          }
                          stepBookingResponse={systemOrgDedupResponse}
                        />
                      </AnimationWrapper>
                    )} */}
                  </div>
