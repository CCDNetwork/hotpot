...
namespace Ccd.Server.Migrations
{
    ...
    [Migration("20260812130355_AddConflictEventsAndDashboard")]
    partial class AddConflictEventsAndDashboard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ccd.Server.Dashboards.ExchangeRate", b =>
                {
                    ...
                    b.HasIndex("Currency", "Year", "Month", "Source")
                        .IsUnique()
            ...
            modelBuilder.Entity("Ccd.Server.Deduplication.BookingConflictEvent", b =>
                {
                    ...
                    b.Property<Guid?>("BlockingBookingId")
                        .HasColumnType("uuid")
                        .HasColumnName("blocking_booking_id");

                    b.Property<Guid>("BlockingOrganizationId")
                        .HasColumnType("uuid")
                        .HasColumnName("blocking_organization_id");
                    ...
                    b.Property<DateOnly>("OverlapEndDate")
                        .HasColumnType("date")
                        .HasColumnName("overlap_end_date");

                    b.Property<DateOnly>("OverlapStartDate")
                        .HasColumnType("date")
                        .HasColumnName("overlap_start_date");
                    ...
                    b.Property<string>("ProposedModality")
                        .HasColumnType("text")
                        .HasColumnName("proposed_modality");

                    b.Property<int>("ProposedRounds")
                        .HasColumnType("integer")
                        .HasColumnName("proposed_rounds");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_booking_conflict_event");

                    b.HasIndex("BlockingBookingId")
                        .HasDatabaseName("ix_booking_conflict_event_blocking_booking_id");

                    b.HasIndex("BlockingOrganizationId")
                        .HasDatabaseName("ix_booking_conflict_event_blocking_organization_id");

                    b.HasIndex("FirstDetectedAt")
                        .HasDatabaseName("ix_booking_conflict_event_first_detected_at");

                    b.HasIndex("RequestingOrganizationId", "BlockingOrganizationId", "SubjectKey", "OverlapStartDate", "OverlapEndDate")
                        .IsUnique()
            ...
            modelBuilder.Entity("Ccd.Server.Deduplication.BookingLog", b =>
                {
                    ...
                    b.HasIndex("SubmissionId")
                        .HasDatabaseName("ix_booking_log_submission_id");
            ...
            modelBuilder.Entity("Ccd.Server.Settings.Settings", b =>
                {
                    ...
                    b.Property<string>("DashboardDisplayCurrency")
                        .HasColumnType("text")
                        .HasColumnName("dashboard_display_currency");
            ...
            modelBuilder.Entity("Ccd.Server.Deduplication.BookingConflictEvent", b =>
                {
                    b.HasOne("Ccd.Server.Deduplication.Booking", "BlockingBooking")
                        .WithMany()
                        .HasForeignKey("BlockingBookingId")
                        .HasConstraintName("fk_booking_conflict_event_booking_blocking_booking_id");

                    b.HasOne("Ccd.Server.Organizations.Organization", "BlockingOrganization")
                        .WithMany()
                        .HasForeignKey("BlockingOrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_booking_conflict_event_organization_blocking_organization_id");

                    b.HasOne("Ccd.Server.Organizations.Organization", "RequestingOrganization")
                        .WithMany()
                        .HasForeignKey("RequestingOrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_booking_conflict_event_organization_requesting_organization~");

                    b.Navigation("BlockingBooking");

                    b.Navigation("BlockingOrganization");
